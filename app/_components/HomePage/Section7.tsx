                ...
                <div className="row testimonials-container margin-top-65">
                    ...
                    <ul className="testimonials-list testimonials-carousel effect-crossfade">
                        <li>
                            ...
                            <h5>"In the last six months we have seen our organizational profitability increase
                                significantly thanks in large part to the change in practices around resource
                                management and global resourcing of our projects."</h5>
