                    ...
                    <ul className="services-list horizontal-carousel clearfix">
                        <li className="column column-1-3">
                            ...
                            <div className="service-details">
                                ...
                                <ul className="simple-list">
                                    <li>Keeping accounting and tax books of revenues and expenses. HR and
                                        payroll services.</li>
                        ...
                        <li className="column column-1-3">
                            ...
                            <div className="service-details">
                                ...
                                <ul className="simple-list">
                                    <li>Creating and implementing strategies as well as support in designing and
                                        changing the business model.</li>
                                    <li>Preparation of business plans, financial forecasts, company valuations.
                                    </li>
                                </ul>
                                <a className="more"
                                    href="/service-post"
                        ...
                        <li className="column column-1-3">
                            ...
                            <div className="service-details">
                                ...
                                <ul className="simple-list">
                                    <li>Audit and reviews of financial statements prepared in accordance with
                        ...
                        <li className="column column-1-3">
                            ...
                            <div className="service-details">
                                ...
                                <ul className="simple-list">
                                    <li>Valuation of the company, key products and the entire brand. Short and
                        ...
                        <li className="column column-1-3">
                            ...
                            <div className="service-details">
                                ...
                                <ul className="simple-list">
                                    <li>Implementation of procedures that increase productivity in the
                                        enterprise. Optimizing decision-making process.</li>
                        ...
                        <li className="column column-1-3">
                            ...
                            <div className="service-details">
                                ...
                                <h3><a href="/service-post"
                                    ...
                                    benefits</a></h3>
                                <ul className="simple-list">
                                    <li>Every organization should have access to robust benefit options and an
                                        employee benefit management system.</li>
