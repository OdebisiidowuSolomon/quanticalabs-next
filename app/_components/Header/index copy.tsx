                            ...
                            <ul className="sf-menu">
                                ...
                                <li className="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="?page=study_company_value_appraisal" title="Company value appraisal">
                                                Company value appraisal
                                            </a>
                                        </li>
                                        <li>
                                            <a href="?page=study_reduction_of_fixed_costs" title="Reduction of fixed costs">
                                ...
                                <li className="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="?page=blog_grid_with_left_sidebar" title="Blog grid with left sidebar">
                                ...
                                <li className="left-flyout submenu">
