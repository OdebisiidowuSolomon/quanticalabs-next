                        ...
                        <ul className="testimonials-list testimonials-carousel scroll-1 visible-2">
                            ...
                            <li className="page-margin-top">
                                <div className="testimonial">
                                    ...
                                    <div className="testimonial-content template-big-quote-after">
                                        <h5>"Business plan. So overlooked in business today. We look a long time to develop it and that was a mistake. Insur allowed us not only to increase profits, but also identified errors and optimized the process."</h5>
