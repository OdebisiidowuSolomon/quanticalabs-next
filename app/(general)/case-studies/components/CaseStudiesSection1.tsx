            ...
            <ul className="projects-list isotope clearfix">
                <li className="strategy column-1-3">
                    <div className="case-study-container">
                        <a href="/case-study-post" title="Consulting for corporations" className="image-box">
                            <img alt="Consulting for corporations" src="images/image_01_7.jpg" />
                        </a>
                        <div className="project-details">
                            <h4><a href="/case-study-post" title="Consulting for corporations">Consulting for corporations</a></h4>
                            <a className="template-right2 more-submit" href="/case-study-post"></a>
                        </div>
                    </div>
                </li>
                <li className="consulting column-1-3">
                    <div className="case-study-container">
                        <a href="/case-study-post" title="Company value appraisal" className="image-box">
                            <img alt="Company value appraisal" src="images/image_02_5.jpg" />
                        </a>
                        <div className="project-details">
                            <h4><a href="/case-study-post" title="Company value appraisal">Company value appraisal</a></h4>
                            <a className="template-right2 more-submit" href="/case-study-post"></a>
                        </div>
                    </div>
                </li>
                <li className="strategy column-1-3">
                    <div className="case-study-container">
                        <a href="/case-study-post" title="Reduction of fixed costs" className="image-box">
                            <img alt="Reduction of fixed costs" src="images/image_03_5.jpg" />
                        </a>
                        <div className="project-details">
                            <h4><a href="/case-study-post" title="Reduction of fixed costs">Reduction of fixed costs</a></h4>
                            <a className="template-right2 more-submit" href="/case-study-post"></a>
                        </div>
                    </div>
                </li>
                <li className="consulting marketing column-1-3">
                    <div className="case-study-container">
                        <a href="/case-study-post" title="Distribution process analysis" className="image-box">
                            <img alt="Distribution process analysis" src="images/image_04_4.jpg" />
                        </a>
                        <div className="project-details">
                            <h4><a href="/case-study-post" title="Distribution process analysis">Distribution process analysis</a></h4>
                            <a className="template-right2 more-submit" href="/case-study-post"></a>
                        </div>
                    </div>
                </li>
                {/* <li className="subsidies column-1-3">
                    <div className="case-study-container">
                        <a href="/case-study-post" title="Optimization of financial flows" className="image-box">
                            <img alt="Optimization of financial flows" src="images/image_05_3.jpg" />
                        </a>
                        <div className="project-details">
                            <h4><a href="/case-study-post" title="Optimization of financial flows">Optimization of financial flows</a></h4>
                            <a className="template-right2 more-submit" href="/case-study-post"></a>
                        </div>
                    </div>
                </li>
                <li className="strategy marketing column-1-3">
                    <div className="case-study-container">
                        <a href="/case-study-post" title="Capital plans for employees" className="image-box">
                            <img alt="Capital plans for employees" src="images/image_06_2.jpg" />
                        </a>
                        <div className="project-details">
                            <h4><a href="/case-study-post" title="Capital plans for employees">Capital plans for employees</a></h4>
                            <a className="template-right2 more-submit" href="/case-study-post"></a>
                        </div>
                    </div>
                </li> */}
