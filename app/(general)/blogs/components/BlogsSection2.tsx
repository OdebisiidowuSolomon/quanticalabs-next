        ...
        <div className="column column-1-3 fp-smart-column">
            <div className="fp-smart-column-wrapper">
                ...
                <ul className="blog small margin-top-36 clearfix">
                    <li>
                        <a href="#" title="5 reasons why your business needs an expense policy" className="post-image">
                            <img src="/images/image_01_4.jpg" alt="" />
                        </a>
                        <div className="post-content">
                            <a href="#" title="5 reasons why your business needs an expense policy">5 reasons why your business needs an expense policy</a>
                            <abbr title="April 10, 2022">April 10, 2022</abbr>
                        </div>
                    </li>
                    <li>
                        <a href="#" title="6 main differences between an LLC and a corporation" className="post-image">
                            <img src="/images/image_02_3.jpg" alt="" />
                        </a>
                        <div className="post-content">
                            <a href="#" title="6 main differences between an LLC and a corporation">6 main differences between an LLC and a corporation</a>
                            <abbr title="March 17, 2022">March 17, 2022</abbr>
                        </div>
                    </li>
                    <li>
                        <a href="#" title="What you need to know about bookkeeping services" className="post-image">
                            <img src="/images/image_03_3.jpg" alt="" />
                        </a>
                        <div className="post-content">
                            <a href="#" title="What you need to know about bookkeeping services">What you need to know about bookkeeping services</a>
                ...
                <form className="search-form page-margin-top" action="?page=search">
                    <div className="border-container">
                        <label>Search</label>
                        <input className="text-input" name="s" type="text" defaultValue="" placeholder="e.g. business consulting" />
                        <input type="hidden" name="page" defaultValue="search" />
                        <fieldset className="search-submit-container">
                            <span className="template-search4"></span>
                            <input type="submit" defaultValue="" className="search-submit" />
                        </fieldset>
                    </div>
                </form>
                <ul className="services-list page-margin-top">
                    <li className="background background-6 fp-overlay">
                        <h3><a href="/service-post" title="Performance management and improvement">Get connected</a></h3>
                        <h5>Feel free to get connected with our dedicated bookkeeping account for business.</h5>
                        <div className="align-center">
                            <a className="more style-4" href="/service-post" title="Get started">Get started</a>
                        </div>
                    </li>
                </ul>
