...
export default function CaseStudyPostSection4() {
    return (
        <div className="row full-width dark page-margin-top-section-large padding-top-95 padding-bottom-70 background-1">
            <div className="row">
